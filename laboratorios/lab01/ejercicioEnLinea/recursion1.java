...
/*
T(n)= O(n)+O(1)+O(n)+O(1)+O(n-1)+O(1)+ O(n-1)= O(2n)+O(3)+O(2n-1) = O(n)
...
//  T(n) = n/10 + 1 + 1 + n/10 - 1 = 1 + 2n = O(log n)
...
// T(n) = 1 + 1 + 1 + 1 + n + n/10 + n/10  = 1 + 4n = O(1 + 4n) = O(log n)
//Ejercicio 5(count8)
...
//O(1)+O(1)+O(1)+O(1)+O(1)+ O(n/10)+O(1) + O(n/10) +O(n/10) = O(log n)